...
class MHASTP(torch.nn.Module):
    ...
    def forward(self, input):
        ...
        for i, layer in enumerate(self.heads_att_trans):
            ...
            # Element-wise multiplication, (32, 1280, 7) -> (32, 1280)
        ...
        # (32, 2560*8) = (32, 20480), chunks_out is a list, not tensor, thus dim=1
